    ...
    do
        ...
        then
            ...
            do
                ...
                python GP_estimator_single_joint.py -config_file './config/PANDA_'$i$'dof_MC_config_tr_num_sin50__SJ.ini' -kernel_name $ker
        ...
        then
            ...
            do
                ...
                do
                    ...
                    python GP_estimator_single_joint.py -config_file './config/PANDA_'$i$'dof_MC_config_test_tr_num_sin50_test_num_sin50__seed'$seed'__SJ.ini' -kernel_name $ker
            ...
            do
                ...
                do
                    ...
                    python GP_estimator_single_joint.py -config_file './config/PANDA_'$i$'dof_MC_config_train-test_tr_num_sin50_test_num_sin50__seed'$seed'__SJ.ini' -kernel_name $ker
                done
            done
        fi
    done
