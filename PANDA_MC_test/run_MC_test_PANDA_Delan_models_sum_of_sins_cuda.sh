    ...
    do
        ...
        then
            ...
            do
                ...
                printf 'Training '$i$' dof Delan Model num_sins 50'
                    python DeLaN_estimator.py -r 0 -m 1 -l 0 -t 1 -c 1 -n ${i} \
        ...
        then
            ...
            do
                ...
                python DeLaN_estimator.py -r 0 -m 1 -l 1 -t 1 -c 1 -n ${i} \
                -saving_path ./Results/${i}dof/tr_num_sin50_train-test_num_sin50_seed${seed}_  \
                -model_loading_path ./Results/${i}dof/tr_num_sin50_train-test_num_sin50_seed${seed}_ \
                -f1 ./data/${i}dof/panda_${i}dof_data_inv_dyn_sum_of_sin__noise_std0.01__w_f0.02__num_sin50__pos_range_0.5__50seconds__seed${seed}.pkl \
                -f2 ./data/${i}dof/panda_${i}dof_data_inv_dyn_sum_of_sin__noise_std0.01__w_f0.02__num_sin50__pos_range_0.5__50seconds__seed$(($seed + 100)).pkl \
                ...
                -f2M ./data/${i}dof/panda_${i}dof_data_M_inv_dyn_sum_of_sin__noise_std0.01__w_f0.02__num_sin50__pos_range_0.5__50seconds__seed$(($seed + 100)).pkl
