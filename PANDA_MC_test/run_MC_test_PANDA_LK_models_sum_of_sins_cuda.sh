    ...
    do
        ...
        then
            ...
            do
                ...
                python LK_GP_estimator_MC.py -config_file './config/PANDA_'$i$'dof_MC_config_tr_num_sin50__cuda.ini' -kernel_name $ker
        ...
        then
            ...
            do
                ...
                do
                    ...
                    python LK_GP_estimator_MC.py -config_file './config/PANDA_'$i$'dof_MC_config_test_tr_num_sin50_test_num_sin50__seed'$seed'__cuda.ini' -kernel_name $ker
            ...
            do
                ...
                do
                    ...
                    python LK_GP_estimator_MC.py -config_file './config/PANDA_'$i$'dof_MC_config_train-test_tr_num_sin50_test_num_sin50__seed'$seed'__cuda.ini' -kernel_name $ker
                done
            done
        fi
    done
