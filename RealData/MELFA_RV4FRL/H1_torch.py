...
def H1(X, pos_dim, vel_dim, acc_dim, dtype, device):
    q = X[:, pos_dim]
    dq = X[:, vel_dim]
    ddq = X[:, acc_dim]
    #
    ...
    H_num[:, 8] = 0
    H_num[:, 9] = 0
    H_num[:, 10] = x0 * x5 + x1 * x7
    H_num[:, 11] = x0 * (x11 + x9) + x1 * (x3 + x5)
    H_num[:, 12] = x1 * (x14 + x16) + x13
    H_num[:, 13] = x0 * x17 + x1 * x11
    H_num[:, 14] = x0 * (x18 + x19) + x1 * (ddq[:, 1] + x20)
    H_num[:, 15] = x0 * x3 + x1 * x9
    H_num[:, 16] = 0.31 * x1 * (x19 + x25) + x1 * (x22 - x24) - 0.31 * x13
    H_num[:, 17] = x0 * (-x22 + x24) + 0.31 * x1 * (x12 + x26) + x27 * (x16 + x19)
    H_num[:, 18] = x0 * (x28 - x29) + 0.31 * x1 * x33 + x27 * (x3 - x5) + x32
    H_num[:, 19] = x27 * x34 + 0.31 * x32
    H_num[:, 20] = x0 * (x35 * x41 + x37 * x45) + x1 * (x35 * x45 + x36 * x41)
    H_num[:, 21] = x0 * (x35 * x49 + x37 * x53) + x1 * (x35 * x53 + x36 * x49)
    H_num[:, 22] = x0 * (x35 * x55 + x37 * x58) + x1 * (x35 * x58 + x36 * x55)
    H_num[:, 23] = x0 * (x35 * x57 + x37 * x44) + x1 * (x35 * x44 + x36 * x57)
    H_num[:, 24] = x0 * (x35 * x61 + x37 * x62) + x1 * (x36 * x61 + x63)
    H_num[:, 25] = x0 * (x35 * x56 + x37 * x54) + x1 * (x35 * x54 + x36 * x56)
    H_num[:, 26] = x0 * x37 * x68 + x1 * x35 * x68 + 0.31 * x1 * (x35 * x69 + x37 * x71) + x27 * (x35 * x71 + x36 * x69)
    H_num[:, 27] = (
        x0 * (x37 * x77 + x75)
        + x1 * (x35 * x77 + x36 * x74)
        + 0.31 * x1 * (x35 * x78 + x37 * x79)
        + x27 * (x35 * x79 + x36 * x78)
    )
    H_num[:, 28] = x0 * x35 * x80 + x1 * x36 * x80 + 0.31 * x1 * (x37 * x82 + x63) + x27 * (x35 * x82 + x36 * x62)
    H_num[:, 29] = 0.31 * x1 * (x35 * x83 + x37 * x74) + x27 * (x36 * x83 + x75)
    H_num[:, 30] = x0 * (x100 * x37 + x35 * x99) + x1 * (x100 * x35 + x36 * x99)
    H_num[:, 31] = x0 * (x109 * x35 + x111 * x37) + x1 * (x109 * x36 + x111 * x35)
    H_num[:, 32] = x0 * (x118 * x35 + x121 * x37) + x1 * (x118 * x36 + x121 * x35)
    H_num[:, 33] = x0 * (x101 * x37 + x122 * x35) + x1 * (x101 * x35 + x122 * x36)
    H_num[:, 34] = x0 * (x127 * x35 + x128 * x37) + x1 * (x127 * x36 + x128 * x35)
    H_num[:, 35] = x0 * (x103 * x37 + x129 * x35) + x1 * (x103 * x35 + x129 * x36)
    H_num[:, 36] = (
        x0 * (x137 * x35 + x141 * x37)
        + 0.31 * x1 * (x115 * x37 + x143 * x35)
        + x1 * (x137 * x36 + x141 * x35)
        + x27 * (x115 * x35 + x143 * x36)
    )
    H_num[:, 37] = (
        x0 * x149 * x35 + x1 * x149 * x36 + 0.31 * x1 * (x151 * x35 + x152 * x37) + x27 * (x151 * x36 + x152 * x35)
    )
    H_num[:, 38] = (
        x0 * (x156 * x35 + x157 * x37)
        + x1 * (x156 * x36 + x157 * x35)
        + 0.31 * x1 * (x159 * x35 + x160 * x37)
        + x27 * (x159 * x36 + x160 * x35)
    )
    H_num[:, 39] = (
        x0 * x161 * x35 + x1 * x161 * x36 + 0.31 * x1 * (x133 * x37 + x163 * x35) + x27 * (x133 * x35 + x163 * x36)
    )
    H_num[:, 40] = x0 * (x184 * x35 + x185 * x37) + x1 * (x184 * x36 + x185 * x35)
    H_num[:, 41] = x0 * (x196 * x35 + x197 * x37) + x1 * (x196 * x36 + x197 * x35)
    H_num[:, 42] = x0 * (x207 * x35 + x208 * x37) + x1 * (x207 * x36 + x208 * x35)
    H_num[:, 43] = x0 * (x211 * x35 + x212 * x37) + x1 * (x211 * x36 + x212 * x35)
    H_num[:, 44] = x0 * (x218 * x35 + x220 * x37) + x1 * (x218 * x36 + x220 * x35)
    H_num[:, 45] = x0 * (x223 * x35 + x224 * x37) + x1 * (x223 * x36 + x224 * x35)
    H_num[:, 46] = (
        x0 * (x242 * x35 + x243 * x37)
        + x1 * (x242 * x36 + x243 * x35)
        + 0.31 * x1 * (x245 * x35 + x246 * x37)
        + x27 * (x245 * x36 + x246 * x35)
    )
    H_num[:, 47] = (
        x0 * (x259 * x35 + x260 * x37)
        + x1 * (x259 * x36 + x260 * x35)
        + 0.31 * x1 * (x262 * x35 + x263 * x37)
        + x27 * (x262 * x36 + x263 * x35)
    )
    H_num[:, 48] = (
        x0 * (x272 * x35 + x273 * x37)
        + x1 * (x272 * x36 + x273 * x35)
        + 0.31 * x1 * (x275 * x35 + x276 * x37)
        + x27 * (x275 * x36 + x276 * x35)
    )
    H_num[:, 49] = (
        x0 * (x281 * x35 + x282 * x37)
        + x1 * (x281 * x36 + x282 * x35)
        + 0.31 * x1 * (x284 * x35 + x285 * x37)
        + x27 * (x284 * x36 + x285 * x35)
    )
    H_num[:, 50] = x0 * (x305 * x35 + x306 * x37) + x1 * (x305 * x36 + x306 * x35)
    H_num[:, 51] = x0 * (x321 * x35 + x322 * x37) + x1 * (x321 * x36 + x322 * x35)
    H_num[:, 52] = x0 * (x335 * x35 + x336 * x37) + x1 * (x335 * x36 + x336 * x35)
    H_num[:, 53] = x0 * (x340 * x35 + x341 * x37) + x1 * (x340 * x36 + x341 * x35)
    H_num[:, 54] = x0 * (x349 * x35 + x350 * x37) + x1 * (x349 * x36 + x35 * x350)
    H_num[:, 55] = x0 * (x35 * x354 + x355 * x37) + x1 * (x35 * x355 + x354 * x36)
    H_num[:, 56] = (
        x0 * (x35 * x376 + x37 * x377)
        + x1 * (x35 * x377 + x36 * x376)
        + 0.31 * x1 * (x35 * x379 + x37 * x380)
        + x27 * (x35 * x380 + x36 * x379)
    )
    H_num[:, 57] = (
        x0 * (x35 * x398 + x37 * x399)
        + x1 * (x35 * x399 + x36 * x398)
        + 0.31 * x1 * (x35 * x401 + x37 * x402)
        + x27 * (x35 * x402 + x36 * x401)
    )
    H_num[:, 58] = (
        x0 * (x35 * x418 + x37 * x419)
        + x1 * (x35 * x419 + x36 * x418)
        + 0.31 * x1 * (x35 * x421 + x37 * x422)
        + x27 * (x35 * x422 + x36 * x421)
    )
    H_num[:, 59] = (
        x0 * (x35 * x432 + x37 * x433)
        + x1 * (x35 * x433 + x36 * x432)
        + 0.31 * x1 * (x35 * x435 + x37 * x436)
        + x27 * (x35 * x436 + x36 * x435)
    )
    H_num[:, 60] = dq[:, 0]
    H_num[:, 61] = torch.sign(dq[:, 0])
    return H_num
