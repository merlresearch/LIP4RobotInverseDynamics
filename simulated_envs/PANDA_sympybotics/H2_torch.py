...
def H2(X, pos_dim, vel_dim, acc_dim, dtype, device):
    q = X[:, pos_dim]
    dq = X[:, vel_dim]
    ddq = X[:, acc_dim]
    #
    ...
    H_num[:, 18] = 0
    H_num[:, 19] = 0
    H_num[:, 20] = x28 * x35 + x29 * x32
    H_num[:, 21] = x28 * x43 + x29 * x41
    H_num[:, 22] = x28 * x53 + x681
    H_num[:, 23] = x28 * x40 + x29 * x54
    H_num[:, 24] = x28 * x58 + x29 * x57
    H_num[:, 25] = x28 * x38 + x29 * x42
    H_num[:, 26] = x28 * x66 + 0.316 * x28 * x67 - 0.316 * x681
    H_num[:, 27] = 0.316 * x28 * x68 + x29 * x65 + x69 * x74
    H_num[:, 28] = 0.316 * x28 * x59 + x29 * x64 + x682 + x73 * x74
    H_num[:, 29] = x63 * x74 + 0.316 * x682
    H_num[:, 30] = x28 * x86 + x29 * x83
    H_num[:, 31] = x28 * x99 + x29 * x94
    H_num[:, 32] = x107 * x29 + x110 * x28
    H_num[:, 33] = x113 * x29 + x28 * x85
    H_num[:, 34] = x118 * x29 + x120 * x28
    H_num[:, 35] = x122 * x29 + x123 * x28
    H_num[:, 36] = x127 * x29 + x135 * x28 + 0.316 * x136 * x28 + x138 * x74
    H_num[:, 37] = x141 * x29 + x146 * x28 + 0.316 * x147 * x28 + x148 * x74
    H_num[:, 38] = x150 * x29 + x153 * x28 + 0.316 * x154 * x28 + x156 * x74
    H_num[:, 39] = x126 * x74 + x159 * x28 + 0.316 * x160 * x28
    H_num[:, 40] = x174 * x29 + x177 * x28
    H_num[:, 41] = x190 * x29 + x192 * x28
    H_num[:, 42] = x203 * x29 + x206 * x28
    H_num[:, 43] = x209 * x29 + x212 * x28
    H_num[:, 44] = x219 * x29 + x221 * x28
    H_num[:, 45] = x225 * x29 + x227 * x28
    H_num[:, 46] = x238 * x29 + x245 * x28 + 0.316 * x246 * x28 + x248 * x74
    H_num[:, 47] = x258 * x29 + x263 * x28 + 0.316 * x264 * x28 + x266 * x74
    H_num[:, 48] = x276 * x29 + x28 * x282 + 0.316 * x28 * x283 + x285 * x74
    H_num[:, 49] = x28 * x296 + 0.316 * x28 * x297 + x29 * x291 + x298 * x74
    H_num[:, 50] = x28 * x316 + x29 * x314
    H_num[:, 51] = x28 * x334 + x29 * x332
    H_num[:, 52] = x28 * x350 + x29 * x348
    H_num[:, 53] = x28 * x358 + x29 * x356
    H_num[:, 54] = x28 * x370 + x29 * x368
    H_num[:, 55] = x28 * x378 + x29 * x376
    H_num[:, 56] = x28 * x399 + 0.316 * x28 * x400 + x29 * x393 + x402 * x74
    H_num[:, 57] = x28 * x423 + 0.316 * x28 * x424 + x29 * x417 + x426 * x74
    H_num[:, 58] = x28 * x444 + 0.316 * x28 * x445 + x29 * x438 + x447 * x74
    H_num[:, 59] = x28 * x459 + 0.316 * x28 * x460 + x29 * x453 + x462 * x74
    H_num[:, 60] = x28 * x483 + x29 * x481
    H_num[:, 61] = x28 * x503 + x29 * x501
    H_num[:, 62] = x28 * x522 + x29 * x520
    H_num[:, 63] = x28 * x533 + x29 * x531
    H_num[:, 64] = x28 * x548 + x29 * x546
    H_num[:, 65] = x28 * x559 + x29 * x557
    H_num[:, 66] = x28 * x590 + 0.316 * x28 * x591 + x29 * x584 + x593 * x74
    H_num[:, 67] = x28 * x621 + 0.316 * x28 * x622 + x29 * x615 + x624 * x74
    H_num[:, 68] = x28 * x651 + 0.316 * x28 * x652 + x29 * x645 + x654 * x74
    H_num[:, 69] = x28 * x676 + 0.316 * x28 * x677 + x29 * x670 + x679 * x74
    H_num[:, 70] = dq[:, 1]
    H_num[:, 71] = torch.sign(dq[:, 1])
    #
    return H_num
