...
def test_scara_dh_sym_geo_kin():
    ...
    scara = sympybotics.robotdef.RobotDef(
        "SCARA - Spong", [(0, a1, 0, q), (pi, a2, 0, q), (0, 0, q, 0), (0, 0, d4, q)], dh_convention="standard"
    )
    ...
    T_spong = sympy.Matrix(
        [
            [
                ...
                0,
                a1 * cos(q1) - a2 * sin(q1) * sin(q2) + a2 * cos(q1) * cos(q2),
            ],
            [
                (sin(q1) * sin(q2) - cos(q1) * cos(q2)) * sin(q4) + (sin(q1) * cos(q2) + sin(q2) * cos(q1)) * cos(q4),
                (sin(q1) * sin(q2) - cos(q1) * cos(q2)) * cos(q4) - (sin(q1) * cos(q2) + sin(q2) * cos(q1)) * sin(q4),
                0,
                a1 * sin(q1) + a2 * sin(q1) * cos(q2) + a2 * sin(q2) * cos(q1),
            ],
            [0, 0, -1, -d4 - q3],
            [0, 0, 0, 1],
        ]
    ...
    J_spong = sympy.Matrix(
        [
            [
                -a1 * sin(q1) - a2 * sin(q1) * cos(q2) - a2 * sin(q2) * cos(q1),
                -a2 * sin(q1) * cos(q2) - a2 * sin(q2) * cos(q1),
                0,
                0,
            ],
            [
                a1 * cos(q1) - a2 * sin(q1) * sin(q2) + a2 * cos(q1) * cos(q2),
                -a2 * sin(q1) * sin(q2) + a2 * cos(q1) * cos(q2),
                0,
                0,
            ],
            [0, 0, -1, 0],
...
def test_puma_dh_num_geo_kin_dyn():
    ...
    dynparm_test = [
        ...
        0,
        1.03118515,
        0.037980719999999996,
        1.4401022999999999,
        3.7274564059999999,
        -0.023751000000000001,
        2.8425240559999998,
        -6.33012,
        0.10439999999999999,
        3.9585,
        17.4,
        0.090474288000000014,
        -0.0013739039999999998,
        0.0068208000000000001,
        0.111498032,
        0.0047375999999999998,
        0.015432319999999999,
        -0.09743999999999998,
        -0.06767999999999999,
        0.336,
        4.8,
        0.0020960200000000001,
        -0,
        -0,
    ...
    dynparm_test2 = [
        ...
        0.3521748260592804,
        0.5384045845183812,
        0.021600503502885116,
        0.4654003203805651,
        0.5202014161122065,
        0.33744920539722967,
        0.052363297799702835,
        0.07051826001770234,
        0.7389222546505236,
        0.771434543548951,
        0.3652539269897015,
    ...
    T_pcorke = numpy.matrix(
        [
            [-0.655113870655343, -0.474277925274361, -0.588120962109346, 0.0540498757911011],
    ...
    J_pcorke = numpy.matrix(
        [
            [0.154761559833806, -0.416115317270121, -0.181051500179202, 0.0, 0.0, 0.0],
    ...
    M_pcorke = numpy.matrix(
        [
            ...
            [
                ...
                2.00048563124708,
                0.306870038373922,
                -0.000227846077158843,
                0.000780985328855223,
                7.53260796283046e-6,
            ],
            [
                -0.0772414386669632,
                0.306870038373922,
                0.361368447500762,
                -0.000267122764221431,
                0.00156301630001611,
                7.53260796283046e-6,
            ],
            [
                0.00110264316988551,
                -0.000227846077158844,
                -0.000267122764221432,
                0.00169083802882858,
                1.45380752747483e-20,
                3.4606953693396e-5,
            ],
            [
                0.000264135330891356,
                0.000780985328855223,
                0.00156301630001611,
                2.33135442795155e-20,
                0.00064216,
                2.44929359829471e-21,
            ],
            [
                2.74006873318143e-6,
                7.53260796283046e-6,
...
def test_puma_mdh_num_geo_kin_dyn():
    ...
    dynparm_test = [
        ...
        0.1350808,
        -0.0070992,
        0.018931199999999999,
        0.60891200000000001,
        0.0016703999999999998,
        0.62008400000000008,
        1.1832,
        0.10439999999999999,
        -0.2784,
        17.4,
        0.090460800000000008,
        0.0,
        0.0,
        0.013440800000000001,
        0.0047039999999999998,
        0.089520000000000002,
        0.0,
        -0.336,
        0.0672,
        4.8,
    ...
    T_pcorke = numpy.matrix(
        [
            [-0.655113870655343, -0.474277925274361, 0.588120962109346, 0.368531204501578],
    ...
    J_pcorke = numpy.matrix(
        [
            [-0.548861637700235, -0.053505039458511, 0.181558777632408, 0.0, 0.0, 0.0],
