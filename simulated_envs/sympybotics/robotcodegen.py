...
def robot_code_to_func(lang, code, outputname, funcname, rbtdef):
    ...
    if not code_symbols.isdisjoint(set(rbtdef.dynparms())):
        ...
        subs_pairs.update(_gen_parms_subs(rbtdef.dynparms(), "parms", offset=idxoffset))
    ...
    return symcode.generation.code_to_func(lang, code, outputname, funcname, func_parms, subs_pairs)
